    ...
    >
      <div className="flex items-start space-x-3">
        ...
        <div className="hidden md:flex md:flex-1 -mx-1 px-1">
          <div className="flex items-center space-x-2 flex-wrap p-1">
            {badges.map((badge) => (
              <TypeBadgeItem
                key={badge.lang}
                type={badge.lang}
        ...
        <div className="flex md:hidden flex-1 -mx-1 px-1 overflow-hidden">
          <div className="flex items-center space-x-2 overflow-x-auto pb-2 scrollbar-hide snap-x snap-mandatory">
            {badges.map((badge) => (
              <TypeBadgeItem
                key={badge.lang}
                type={badge.lang}
